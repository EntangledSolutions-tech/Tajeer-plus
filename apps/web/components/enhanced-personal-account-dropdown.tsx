...
import { ChevronsUpDown, Home, LogOut, User as UserIcon, Settings } from 'lucide-react';
...
export function EnhancedPersonalAccountDropdown({
  className,
  user,
  signOutRequested,
  ...
  const signedInAsLabel = user?.email ?? user?.phone ?? '';
      ...
      <DropdownMenu>
        ...
        >
          <ProfileAvatar
            ...
            fallbackClassName={'rounded-full border'}
